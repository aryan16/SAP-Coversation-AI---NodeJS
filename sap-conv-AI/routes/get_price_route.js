...
module.exports = function(app) {
    ...
    app.post('/get_price', function(req, res) {
        ...
        function getpricedata(result) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                request.post({
                    ...
                    var price_data = JSON.parse(body);
                    price_data_new = price_data.d;
                    console.log(price_data_new);
        ...
        get_token()
            .then(result_price => getpricedata(result_price))
            .then(function(data) {
                var final_data = {
                ...
                if (data.d.message) {
                    ...
                    var new_data = {
                        ...
                        "replies": [{
                                "type": "text",
                                "content": `Net Price for this order is ${data.d.Netwr}`
                            },
                            {
                                "type": "text",
                                "content": "If you have any other query, please ask!!"
